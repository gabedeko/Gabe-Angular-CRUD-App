...
<head>
	...
	<meta charset="utf-8">
	 ...
	 <title>Gabe's CRUD app</title>

	 <link rel="stylesheet" href="libs/style/materialize/dist/css/materialize.min.css" />
...
<!--page content and controls -->
	<div class="container" ng-app="myApp" ng-controller="productsCtrl">
	    <div class="row">
	        <div class="col s12">
	        	<h3>AngularJS, PHP, and MySQL CRUD App</h3><h5>by Gabriel Dekoladenu</h5>
	        	<hr>
	            <h4>Products</h4>
...
<script type="text/javascript" src="libs/js/jquery/dist/jquery.min.js"></script>

<script src="libs/style/materialize/dist/js/materialize.min.js"></script>
