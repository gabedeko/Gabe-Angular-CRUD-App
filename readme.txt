...
CRUD (create, read, update, delete) web application built using AngularJS for databinding and animations, PHP for communication between the server and client page, MySQL for database storage, and Materialize for the style framework.


1. Run SQL script below to create database
...
2. Run SQL script below to add data to table
